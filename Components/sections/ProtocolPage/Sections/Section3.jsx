...
const Section3 = () => {
  return (
    <div className=" bg-purpleCommunityLight">
      <Container>
        <SectionImageLeft img="/img/protocol/image3.png">
          <ParagraphContainers textcolor="black" margin={true}>
            ...
            <p>
              ...
              services decarbonizing the grid while monetizing (1) energy
              surplus, (2) storage capacity, and (3) carbon offset attributes.
            </p>
            <p>
              ...
              technologies and climate tech solutions. It will hold climate
              action workshops/speakers and allow local residents to vote for
              projects they want to support. Sensitizing and engaging community
              members in the direction forward for humanity.
            </p>
          </ParagraphContainers>
        </SectionImageLeft>
      </Container>
