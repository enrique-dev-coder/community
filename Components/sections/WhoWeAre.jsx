    ...
    <div className="relative mb-10 max-w-[1440px] overflow-x-hidden lg:mx-auto  lg:w-[95%] lg:pt-24">
      ...
      >
        ...
        <div className="mb-10 flex flex-col space-y-4 lg:col-span-5 lg:mb-0  lg:justify-center xl:col-span-6">
          <FadeinElement>
            <h2 className="mt-1 mb-4 border border-purpleCommunity py-2 text-center text-[22px] uppercase  lg:w-6/12  lg:text-2xl xl:w-5/12 ">
              Who we are
            </h2>
          </FadeinElement>
          <FadeinElement>
            <p
              className="whitespace-pre-line  text-left text-sm md:text-base lg:w-[95%]   "
              style={{
            ...
            >
              ...
              <b>Prosumer Communities.</b>
            </p>
          </FadeinElement>
          <FadeinElement>
            <p
              className=" mb-4 whitespace-pre-line  text-left text-sm md:text-base lg:w-[95%]   "
              style={{
                fontFamily: " 'Montserrat', sans-serif",
              }}
            >
              Prosumer Communities are{' '}
        ...
        <div className="col-span-1  mt-12 hidden h-[286px] w-[559px] lg:col-span-7 lg:block xl:col-span-6  ">
          <FadeinImg src="/img/entorno-v2.png" className="" />
        </div>
